...
│   ├── server.js             #   MCP server factory + 8 tools（registry_list/workspace_status/run_dispatch/run_status/run_collect/run_diagnose/run_delivery/run_delivery_decide）
