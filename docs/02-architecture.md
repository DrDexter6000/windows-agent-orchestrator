...
│   ├── server.js             #   MCP server factory + 14 tools（registry_list/workspace_status/run_dispatch/run_status/run_wait/run_collect/run_diagnose/run_delivery/run_delivery_review/run_delivery_decide/run_stop/runs_list/playbook_list/playbook_get）
