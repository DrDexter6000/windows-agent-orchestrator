...
```jsonc
{
  "agents": {
    ...
    "coder_dsh_acp": {
      ...
      "cwd": "D:/projects/my-app"
      // 注意：不配 model/provider 块——ACP 面对二者无可验证设置通道，配了会被
